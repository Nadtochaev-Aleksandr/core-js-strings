...
function removeLeadingWhitespaces(value) {
  const resultString = value.trimStart();
  return resultString;
}
...
function formatTime(minutes, seconds) {
  ...
  throw new Error('Введены отрицательные значения времени');
}
